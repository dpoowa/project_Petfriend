...
<body>
	...
	<!-- 상세페이지 시작 -->
	<div id="petteacher-detail" class="off">

		<div class="content_wrap">
			<a class="back_list_btn _content_detail_btn">목록으로</a> <!-- 기본링크 무시하고 클릭이벤트넣기 -->
			...
			<div class="content_main">
				<div class="content_video">
					<!-- 영상이 배치될 div: 이 안에 iframe이 자동으로 생성됨-->
				</div>
...
<!-- 				<a class="next_content_btn _content_detail_btn" href="#;">다음으로&gt;</a> -->
			...
			<a class="back_list_btn _content_detail_btn">목록으로</a>
		</div>
	</div>
	<!-- 상세페이지 종료 -->
